...
<h1 align="center">
    <img src="https://readme-typing-svg.herokuapp.com/?font=Righteous&size=35&center=true&vCenter=true&width=500&height=70&duration=5500&lines=Hello+world+.+.+.;I'm+Cauê+Oliveira;Wellcome+to+my+Github+!;" />
</h1>
...
class Dev:
    ...
    @staticmethod
    def display_data():
        print(f"Skills from developer {Dev.NAME}")
        for language, proficiency in languages.items():
            print(f"{language}: {proficiency}")
